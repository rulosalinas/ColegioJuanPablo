Public Class vcarreras
    ...
    Dim nombrecarrera, resolucion As String
    ...
    Public Sub New(ByVal idcarrera As Integer, ByVal idnivel As Integer, ByVal nombrecarrera As String, ByVal resolucion As String, ByVal duracion As Integer)
