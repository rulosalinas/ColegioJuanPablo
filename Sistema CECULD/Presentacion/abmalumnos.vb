Public Class frmabmalumnos
    ...
    Private Sub btnguardaralta_Click(sender As Object, e As EventArgs) Handles btnguardaralta.Click
        If Me.ValidateChildren = True And txtnombre.Text <> "" And txtapellido.Text <> "" And txtdni.Text <> "" And txtdomicilio.Text <> "" And txtlocalidad.Text <> "" And txttelefono.Text <> "" Then
            Try
